...
$getScheSql = $wpdb->prepare("SELECT * from {$tableSchedules} where roomid=%d and status=%d", 0, 1);
$schedules = $wpdb->get_results($getScheSql);
$getdailiesSql = $wpdb->prepare("SELECT * from {$tableDailySchedules} where roomid=%d", 0);
							$dailies = $wpdb->get_results($getdailiesSql);
							if (isset($dailies[0]->daily)) $dailies = explode(",", $dailies[0]->daily);
							else $dailies = array();

							$getTimesSql = $wpdb->prepare("SELECT * from {$tableDailyTimes} where roomid=%d", 0);
...
?>	
							...
							<input class="scwatbwsr_room_id" value="0" type="hidden">
								...
								<div class="scwatbwsr_room_content">
									<div class="scwatbwsr_room_content_tabs">
										<input class="scwatbwsr_room_content_tabs_input" id="scwatbwsr_tab1" type="radio" name="scwatbwsr_tabs1">
										<label class="scwatbwsr_room_content_tabs_label <?= getActiveClass(1, 'scwatbwsr_tab1') ?>" for="scwatbwsr_tab1"><i class="fa fa-cog"></i><span><?php echo esc_html__("Restaurant Setting", "scwatbwsr-translate") ?></span></label>

										<input class="scwatbwsr_room_content_tabs_input" id="scwatbwsr_tab2" type="radio" name="scwatbwsr_tabs2">
										<label class="scwatbwsr_room_content_tabs_label <?= getActiveClass(2, 'scwatbwsr_tab2') ?>" for="scwatbwsr_tab2"><i class="fa fa-codepen"></i><span><?php echo esc_html__("Room Mapping", "scwatbwsr-translate") ?></span></label>

										<input class="scwatbwsr_room_content_tabs_input" id="scwatbwsr_tab3" type="radio" name="scwatbwsr_tabs3">
										<label class="scwatbwsr_room_content_tabs_label <?= getActiveClass(3, 'scwatbwsr_tab3') ?>" for="scwatbwsr_tab3"><i class="fa fa-calendar"></i><span><?php echo esc_html__("Schedules", "scwatbwsr-translate") ?></span></label>


										<input class="scwatbwsr_room_content_tabs_input" id="scwatbwsr_tab4" type="radio" name="scwatbwsr_tabs4">
										<label class="scwatbwsr_room_content_tabs_label <?= getActiveClass(4, 'scwatbwsr_tab4') ?>" for="scwatbwsr_tab4"><i class="fa fa-calendar"></i><span><?php echo esc_html__("Table Settings", "scwatbwsr-translate") ?></span></label>

										<input class="scwatbwsr_room_content_tabs_input" id="scwatbwsr_tab5" type="radio" name="scwatbwsr_tabs5">
										<label class="scwatbwsr_room_content_tabs_label <?= getActiveClass(5, 'scwatbwsr_tab5') ?>" for="scwatbwsr_tab5"><i class="fa fa-usd"></i><span><?php echo esc_html__("Ippayware", "scwatbwsr-translate") ?></span></label>

										<input class="scwatbwsr_room_content_tabs_input" id="scwatbwsr_tab6" type="radio" name="scwatbwsr_tabs6">
										<label class="scwatbwsr_room_content_tabs_label <?= getActiveClass(6, 'scwatbwsr_tab6') ?>" for="scwatbwsr_tab6"><i class="fa fa-th"></i><span><?php echo esc_html__("Twilio", "scwatbwsr-translate") ?></span></label>

										



										<section id="scwatbwsr_content1" class="tab-content <?= getActiveClass(1, 'scwatbwsr_tab1') ?>">
										<div class="scwatbwsr_content mb-3">
												<div class="content">
									                     <form action='options.php' method='post'>
														 <?php 
														
										settings_fields( 'pluginSCWTBWSRRest' );
										
										$options=get_option('scwatbwsr_settings_rest');
										if(!$options)
										$options=[];
	...
	?>
								...
								<div class="general-setting-left">
									<p><?php echo __('Restaurant Name','scwatbwsr-translate')?></p>
								</div>
								<div class="general-setting-right">
									<input type="text" value="<?=@$options['restaurant_name']?>" name="scwatbwsr_settings_rest[restaurant_name]" class="require-deposit-scw">
									<p><?php echo __('Restaurant Name','scwatbwsr-translate')?></p>
								</div>
							</div> 
							<div class="general-setting-scw">
								...
								<div class="general-setting-right">
									...
									<label class="sap-admin-switch">
										<input name="scwatbwsr_settings_rest[enabled_payment]" <?php if(@$options['enabled_payment']=="on") echo "checked='true'";?> type="checkbox" class="sap-admin-option-toggle">
							...
							<div class="general-setting-scw">
								...
								<div class="general-setting-right">
									<!-- <input type="checkbox"> -->
									<label class="sap-admin-switch">
										<input name="scwatbwsr_settings_rest[offline_payment]" <?php if(@$options['offline_payment']=="on") echo "checked='true'";?> type="checkbox" class="sap-admin-option-toggle">
										<span class="sap-admin-switch-slider round"></span>
									</label>
							...
							<div class="general-setting-scw">
								...
								<div class="general-setting-right">
									<input type="number"  min="1" max="99" value="<?=@$options['pay_later']?>" name="scwatbwsr_settings_rest[pay_later]" class="require-deposit-scw">
							...
							<div class="general-setting-scw">
								...
								<div class="general-setting-right">
									<div class="form-radio-scw-per">
											<input type="radio" id="reservation" <?php if(@$options['customer_table']=="yes") echo "checked='true'";?> name="scwatbwsr_settings_rest[customer_table]" value="yes">
											<label for="html">Yes</label>
										</div>
										<div class="form-radio-scw-per">
											<input type="radio" id="guest" <?php if(@$options['customer_table']=="no") echo "checked='true'";?> name="scwatbwsr_settings_rest[customer_table]" value="no">
											<label for="css">No</label>
										</div>
									<p><?php echo __('Rooms choose by, per customer or Manager','scwatbwsr-translate')?>?</p>
								</div>
							</div>
							<div class="general-setting-scw">
								<div class="general-setting-left">
									<p><?php echo __('Booking Time','scwatbwsr-translate')?></p>
								</div>
								<div class="general-setting-right">
									<input type="text"  value="<?=@$options['booking_time']?>" name="scwatbwsr_settings_rest[booking_time]" class="require-deposit-scw">
									<p><?php echo esc_html__("Booking Time (in minutes - the time customers will stay)", "scwatbwsr-translate") ?></p>
								</div>
							</div>
							<div class="general-setting-scw">
								<div class="general-setting-left">
									<p><?php echo esc_html__("Restaurant hall Size", "scwatbwsr-translate") ?></p>
								</div>
								<div class="general-setting-right">
									<input type="text"  value="<?=@$options['restaurant_size_width']?>" name="scwatbwsr_settings_rest[restaurant_size_width]" class="require-deposit-scw">
									<input type="text"  value="<?=@$options['restaurant_size_height']?>" name="scwatbwsr_settings_rest[restaurant_size_height]" class="require-deposit-scw">
									<p><?php echo esc_html__("Booking Time (in minutes - the time customers will stay)", "scwatbwsr-translate") ?></p>
								</div>
							</div>
							<div class="general-setting-scw">
								<div class="general-setting-left">
									<p><?php echo esc_html__("Table Booked Color", "scwatbwsr-translate") ?></p>
								</div>
								<div class="general-setting-right">
									<input type="color"  value="<?=@$options['table_booked_color']?>" name="scwatbwsr_settings_rest[table_booked_color]" class="require-deposit-scw">
									<p><?php echo esc_html__("Table booked color will show on the live page", "scwatbwsr-translate") ?></p>
								</div>
							</div>
							<div class="general-setting-scw">
								<div class="general-setting-left">
									<p><?php echo esc_html__("Table Booked Seat Color", "scwatbwsr-translate") ?></p>
								</div>
								<div class="general-setting-right">
									<input type="color"  value="<?=@$options['seat_booked_color']?>" name="scwatbwsr_settings_rest[seat_booked_color]" class="require-deposit-scw">
									<p><?php echo esc_html__("Table  booked  seat color will show on the live page", "scwatbwsr-translate") ?></p>
								</div>
							</div>
							<div class="general-setting-scw">
								<div class="general-setting-left">
									<p><?php echo __('Background Color','scwatbwsr-translate')?></p>
								</div>
								<div class="general-setting-right">
									
									<input name="scwatbwsr_settings_rest[background_color]" type="color" id="scwatbwsr_roombg_con_color" class="require-deposit-scw " value="<?php echo esc_attr(@$options['background_color']) ?>" type="text">
									<p><?php echo __('Restaurant Background Color','scwatbwsr-translate')?></p>
								</div>
							</div>
							<div class="general-setting-scw">
								<div class="general-setting-left">
									<p><?php echo __('Or Background Image','scwatbwsr-translate')?></p>
								</div>
								<div class="general-setting-right">
									
									<input name="scwatbwsr_settings_rest[background_image]" disabled="true" type="text"   value="<?php echo esc_attr(@$options['background_color']) ?>" type="text" class="require-deposit-scw">
									<span class="scwatbwsr_roombg_con_upload scwatbwsr_media_upload"><?php echo esc_html__("Upload Image", "scwatbwsr-translate") ?></span>
									<p><?php echo __('Restaurant Background Image','scwatbwsr-translate')?></p>
								</div>
							</div>
			        ...
			        ?>
										...
										<section id="scwatbwsr_content2" class="tab-content <?= getActiveClass(2, 'scwatbwsr_tab2') ?>">
										<div class="tablesize">
											<?php
											 $roomLists = getAllroomsLiveView();
											 foreach ($roomLists as $room) { ?>
											<div class="leaderboard tablesize-drag" data-id="<?=$room->id?>" style="<?="top:".$room->rtop."px;left:".$room->rleft."px;"?>">
											<header>
											<h1 class="leaderboard__title"><span class="leaderboard__title--top"><?=$room->roomname?></span><span class="leaderboard__title--bottom">Totoal Table (<?=$room->count?>)</span></h1>
                                             </header>
											 <main class="leaderboard__profiles">
												...
												?>
												<span class="leaderboard__name"><?=$t->label?>  <span class="leaderboard__value"><?=$t->seats?></span></span>
										...
										<section id="scwatbwsr_content3" class="tab-content <?= getActiveClass(3, 'scwatbwsr_tab3') ?>">
											<div class="scwatbwsr_schedules_spec">
												...
												<div class="scwatbwsr_schedules_spec_reload">
													<p><span class="scwatbwsr_schedules_spec_add_reload" data-id="0"><?php echo esc_html__("Refresh Data", "scwatbwsr-translate") ?> <i class="fa fa-refresh" aria-hidden="true"></i></span></p>
												</div>
											</div>
										...
										<section id="scwatbwsr_content4" class="tab-content <?= getActiveClass(5, 'scwatbwsr_tab4') ?>">
											<span class="scwatbwsr_roomtype_add">
												...
												<span class="scwatbwsr_roomtype_add_reload" data-id="0"><?php echo esc_html__("Refresh Data", "scwatbwsr-translate") ?> <i class="fa fa-refresh" aria-hidden="true"></i></span>
											</span>
...
?>
                <section id="scwatbwsr_content5" class="tab-content <?= getActiveClass(5, 'scwatbwsr_tab5')?>">
											
		            <div class="scwatbwsr_content mb-3">
														
						<div class="content">
							<form action='options.php' method='post'>
							 <?php settings_fields( 'pluginSCWTBWSRPay' );
							...
							?>		
                             <div class="general-setting-scw">
								...
								<div class="general-setting-right">
									<input type="text" value="<?=@$options['api_key']?>" name="scwatbwsr_settings_ippayware[api_key]" class="require-deposit-scw">
							 ...
							 <div class="general-setting-scw">
								...
								<div class="general-setting-right">
									<input type="text"  value="<?=@$options['api_secret']?>" name="scwatbwsr_settings_ippayware[api_secret]" class="require-deposit-scw">
							 ...
							 <div class="general-setting-scw">
								...
								<div class="general-setting-right">
									<input type="text"  value="<?=@$options['commission']?>" name="scwatbwsr_settings_ippayware[commission]" class="require-deposit-scw">
				...
				<section id="scwatbwsr_content6" class="tab-content <?= getActiveClass(6, 'scwatbwsr_tab6') ?>">
					<div class="scwatbwsr_content mb-3">
						<div class="content">
							<form action='options.php' method='post'>
							<?php 
							 settings_fields( 'pluginSCWTBWSRTwilio' );
							$options=get_option('scwatbwsr_settings_twilio');
							if(!$options)
							$options=[];
							?>
							<div class="scwatbwsr_content">
								<div class="general-setting-scw">
									...
									<div class="general-setting-right">
										<input type="text" value="<?=@$options['twilio_sid']?>" name="scwatbwsr_settings_twilio[twilio_sid]" class="require-deposit-scw">
								...
								<div class="general-setting-scw">
									...
									<div class="general-setting-right">
										<input type="text"  value="<?=@$options['twilio_secert']?>" name="scwatbwsr_settings_twilio[twilio_secert]" class="require-deposit-scw">
								...
								<div class="general-setting-scw">
									...
									<div class="general-setting-right">
										<input type="text"  value="<?=@$options['twilio_account_sid']?>" name="scwatbwsr_settings_twilio[twilio_account_sid]" class="require-deposit-scw">
								...
								<div class="general-setting-right">
										<input type="text" value="<?=@$options['twilio_number']?>" name="scwatbwsr_settings_twilio[twilio_number]" class="require-deposit-scw">
