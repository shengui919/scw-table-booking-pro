							...
							<div class="scwatbwsr_room">
								...
								<div class="scwatbwsr_room_content <?= $room->id ?>">
									<div class="scwatbwsr_room_content_tabs">
										...
										<label class="scwatbwsr_room_content_tabs_label <?= getActiveClass($room->id, 'scwatbwsr_tab2') ?>" for="scwatbwsr_tab2<?php echo esc_attr($room->id) ?>"><i class="fa fa-codepen"></i><span><?php echo esc_html__("Table Settings", "scwatbwsr-translate") ?></span></label>
										...
										<section id="scwatbwsr_content5<?php echo esc_attr($room->id) ?>" class="tab-content <?= getActiveClass($room->id, 'scwatbwsr_tab5') ?>">
											<span class="scwatbwsr_tables_add">
												...
												<input class="scwatbwsr_tables_add_seats" type="text" placeholder="Label of seats eg:(1,2,3,4)">
