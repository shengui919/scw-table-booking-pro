									...
									<div class="scwatbwsr_room">
										...
										<div class="scwatbwsr_room_content">
											<div class="scwatbwsr_room_content_tabs">
												...
												<label class="scwatbwsr_room_content_tabs_label <?=getActiveClass($room->id,'scwatbwsr_tab7')?>" for="scwatbwsr_tab7<?php echo esc_attr($room->id) ?>"><i class="fa fa-file-text-o"></i><span><?php echo esc_html__("Payment Settings", "scwatbwsr-translate") ?></span></label>
											...
											<div class="">
												<span class="">
													<table class="accordion_table_width">
														<thead>
															<tr>
																<td style="color: #fff; background: #416b8f;">Table Name and Seat</th>
																<td style="color: #fff; background: #416b8f;">Action</th>
                                                            </tr>
                                                        </thead>
														<tbody>
													<?php
