...
$latestBookings =  $wpdb->get_results($wpdb->prepare("select id,name,schedule,booking_status,seats,no_seats from $table_name where name!='%s' order by id desc limit 4",''));
$count_new_booking = $wpdb->get_var("select count(id) from $table_name p where schedule >=date('Y-m-d H:i')");
$count_table_booking = $wpdb->get_var("select count(id) from $table_name p where seats !=''");
$count_seated_booking = $wpdb->get_var("select count(id) from $table_name p where booking_status ='pending' OR booking_status ='trash'");	
$count_confirmed_booking = $wpdb->get_var("select count(id) from $table_name p where booking_status ='closed' OR booking_status ='confirmed'");	
$count_week_booking=[];
$count_week_booking['sunday'] = $wpdb->get_var("select count(id) from $table_name p where DAYOFWEEK(schedule) ='0'");	
$count_week_booking['monday'] = $wpdb->get_var("select count(id) from $table_name p where DAYOFWEEK(schedule) ='1'");	
$count_week_booking['tuesday'] = $wpdb->get_var("select count(id) from $table_name p where DAYOFWEEK(schedule) ='2'");	
$count_week_booking['wednesday'] = $wpdb->get_var("select count(id) from $table_name p where DAYOFWEEK(schedule) ='3'");
$count_week_booking['thursday'] = $wpdb->get_var("select count(id) from $table_name p where DAYOFWEEK(schedule) ='4'");	
$count_week_booking['friday'] = $wpdb->get_var("select count(id) from $table_name p where DAYOFWEEK(schedule) ='5'");	
$count_week_booking['saturday'] = $wpdb->get_var("select count(id) from $table_name p where DAYOFWEEK(schedule) ='6'");	
...
<div class="wrap">
    <div class="scwatbwsr_content">
		...
		<div class="scwatbwsr_content pd-10 mb-3">
    <div class="dashboardrow">
					<div class="col-xl-3 col-sm-6">
						<div class="card gradient-1 card-bx">
							<div class="card-body d-flex align-items-center">
								<div class="me-auto text-white">
									<h2 class="text-white"><?=$count_new_booking?$count_new_booking:0?></h2>
					...
					<div class="col-xl-3 col-sm-6">
						<div class="card gradient-2 card-bx">
							<div class="card-body d-flex align-items-center">
								<div class="me-auto text-white">
									<h2 class="text-white"><?=$count_table_booking?$count_table_booking:0?></h2>
									<span class="fs-18">Schedule Table</span>
								</div>
								<svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-3 col-sm-6">
						<div class="card gradient-3 card-bx">
							<div class="card-body d-flex align-items-center">
								<div class="me-auto text-white">
									<h2 class="text-white"><?=$count_seated_booking?$count_seated_booking:0?></h2>
									<span class="fs-18">Cancelled</span>
								</div>
								<svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-3 col-sm-6">
						<div class="card gradient-4 card-bx">
							<div class="card-body d-flex align-items-center">
								<div class="me-auto text-white">
									<h2 class="text-white"><?=$count_confirmed_booking?$count_confirmed_booking:0?></h2>
									<span class="fs-18">Confimed</span>
								</div>
     ...
     <div class="scwatbwsr_content_row scwatbwsr_content_row_add pd-10"> 
      <article class="dashboard-others">
            <section class="section">
                    <div class="section-titles">
                        <div class="section-title">Newest Booking</div>
                        <div class="section-subtitle">
                            <div class="weeks-option">
                                <a href="admin.php?page=scwatbwsr-table-bookings" class="weeks-option__item">More</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <li class="monitor-list__item">
                            <div class="monitor-data-list">
                                <div class="dz-image-bx rounded">
                                  
                                  <div class="dz-info">
                                    <h5><?=$booking->name?></h5>
                                    <span class="text-primary"><?=date("M jS, Y, H:i",strtotime($booking->schedule))?></span>
                                    <div class="d-flex flex-wrap mt-3">
                                      <span class="me-auto pe-3">Room A-21</span>
                                      <span><strong><?=$booking->no_seats?> Persons</strong></span>
                                    </div>
                                     </div>
                                </div>
                    ...
                    <a href="admin.php?page=scwatbwsr-table-bookings" class="weeks-option__item" style="float:right;color:rgb(27 51 95)">All bookings</a>
                </section>
           
            </article>
        
    </div>
    <div class="scwatbwsr_content_row pd-10">
          ...
          <article class="dashboard-content">
                ...
                <section class="section">
                    <div class="section-titles">
                        ...
                        <div class="section-subtitle">
                            <div class="weeks-option">
                            <div class="dropdown">
                              <button class="dropbtn weeks-option__item"><span id="filter_label">Filter</span><i class="fa fa-filter"></i></button>
                                  <div class="dropdown-content">
                                      <a href="javascript:reportsFilter('today')" class="weeks-option__item today">Today</a>
                                      <a href="javascript:reportsFilter('week')" class="weeks-option__item active week">Week</a>
                                      <a href="javascript:reportsFilter('month')" class="weeks-option__item month">Month</a>
                                      <a href="javascript:reportsFilter('yesterday')" class="weeks-option__item yesterday">Yesterday</a>
                                      <a href="javascript:reportsFilter('last_week')" class="weeks-option__item last_week">Last Week</a>
                                      <a href="javascript:reportsFilter('last_month')" class="weeks-option__item last_month">Last Month</a>
                                      <a href="javascript:openCustomDate(2)" class="weeks-option__item 2">Choose Year</a>
                                      <a href="javascript:openCustomDate(1)" class="weeks-option__item 1">Choose Date</a>
                     ...
                     <div class="cards reports-filter">
            <div class="card card-1">
              <div class="card__icon"><i class="fa fa-credit-card"></i></div>
              
              <h2 class="card__title online_revenue"></h2>
              <p class="card__apply">
                 Online Revenue
              </p>
            </div>
            <div class="card card-2">
              <div class="card__icon"><i class="fa fa-table"></i></div>
            
              <h2 class="card__title booked_table"></h2>
              <p class="card__apply">
              Booked Table
              </p>
            </div>
            <div class="card card-3">
              <div class="card__icon"><i class="fa fa-check"></i></div>
              
              <h2 class="card__title confirmed_table"></h2>
              <p class="card__apply">
              Confimed Table
              </p>
            </div>
            <div class="card card-4">
              <div class="card__icon"><i class="fa fa-remove"></i></div>
            
              <h2 class="card__title cancelled_table"></h2>
            ...
            <div class="card card-5">
              <div class="card__icon"><i class="fa fa-money"></i></div>
             
              <h2 class="card__title total_revenue"></h2>
              <p class="card__apply">
              Total Revenue
              </p>
            </div>
            <div class="card card-1">
              <div class="card__icon"><i class="fa fa-minus"></i></div>
            
              <h2 class="card__title total_expenses"></h2>
              <p class="card__apply">
              Total Expenses
            </div>
          </div>
                ...
                <section class="section">
                               <div class="section-titles">
                                   ...
                                   <div class="section-subtitle">
                                        <div class="weeks-option">
                                          <div class="dropdown">
                                            <button class="dropbtn weeks-option__item"><span id="filter_label_year">Select Year</span><i class="fa fa-filter"></i></button>
                                              <div class="dropdown-content">
                                                <?php for($i=date("Y");$i>date("Y")-10;$i--){?>
                                                <a href="javascript:reportsFilterYear(<?=$i?>)" class="weeks-option__item_year year_<?=$i?>"><?=$i?></a>
                                                 <?php  } ?>
                                                </div>
                                          </div>
                                         </div>
                    ...
                    <div class="statistics">
                        <div class="progress-data">
                            <div class="progress-text">
                                <div class="progress-weekday">Top Day/<?=strtoupper(array_search(max($count_week_booking),$count_week_booking))?></div>
                                <div class="progress-rate"><?=max($count_week_booking)?></div>
                            </div>
                        </div>
                        <ul class="progress-list">
                          <?php foreach($count_week_booking as $key=>$count) { ?>
                            <li class="progress-list__item">
                                <div class="weekday-abbr">
                                    <?=strtoupper(substr($key,0,2))?>
                                </div>
                                <progress class="progress-bar" max="<?=array_sum($count_week_booking)?>" value="<?=$count?>"></progress>
                            </li>
                           <?php  } ?>
